    ...
    public partial class Form1 : Form
    {
        ...
        public Form1() :base()
        {
         ...
         private void LockForm_Load(object sender, EventArgs e)
         {
            ...
            this.LockForm.Region = region;
            this.LockForm.Text = "LOCK";
            this.LockForm.BackColor = Color.Red;
            this.LockForm.ForeColor = Color.Red;
            this.LockForm.FormBorderStyle = FormBorderStyle.None;
            this.LockForm.Location = new Point(this.Right - 100, 50);

            //Font drawFont = new Font("Arial", 16);
            //SolidBrush drawBrush = new SolidBrush(Color.Red);
            //var graph = this.LockForm.CreateGraphics();
            //graph.DrawString("UNLOCK", drawFont, drawBrush, new Point(0, 0));

            Label text = new Label();
            text.Text = "UNLOCK";
            this.LockForm.Controls.Add(text);
         }
        ...
        {
            this.LockForm.Hide();
            lockPage.Checked = false;
            this.lockPage_Check(null, null);
        }

        private void Form1_SizeChange(object sender, System.EventArgs e)
        {
            //this.ContainerPanel.Size = this.Size;
            //this.ContainerPanel.Location = this.Location;
            //this.Region = new Region(this.Bounds);
        }
        ...
        private void InitializeForm()
        {
            ...
            Form1.lockPage.Location = new Point(lockPageLabel.Right + 2);
            Form1.lockPage.CheckedChanged += new EventHandler(lockPage_Check);
            Form1.lockPage.TextAlign = ContentAlignment.MiddleLeft;
            ...
            //this.nonBrowserArray = new Control[7] {scrollLabel, trackBar1, lockPage, lockPageLabel, toolStrip1, toolStrip2, statusStrip1 };


            

            //this.ContainerPanel.Controls.Add(webBrowser1);
            //this.Region = new Region(this.Bounds);
            //this.webBrowser1.MouseClick += new MouseEventHandler(Form1_MouseDown);
            //this.MouseEnter += new MouseEventHandler(Form1_MouseDown);
            this.webBrowser1.MouseDown += new MouseEventHandler(Form1_MouseDown);
            this.webBrowser1.MouseMove += new MouseEventHandler(Form1_MouseDown);
        }
        ...
        private void lockPage_Check(object sender, EventArgs e)
        {
            if (lockPage.Checked)
            {
                ...
                {
                    Controls.Remove(this.nonBrowserArray[i]);
                }
            ...
            else
            {
                ...
                Controls.AddRange(this.nonBrowserArray);
            }
        }
        ...
        private void LockForm_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (lockPage.Checked)
                {
                    SendMessage(this.LockForm.Handle, WM_NCLBUTTONDOWN, HT_CAPTION, 0);
                }
                else
                {
